...
const LONG_BAY_DECOR: TrackDecor = {
  ...
  boats: [
    [371, 165, 0.62, 1.57], [12, 335, 0.6, 1.57], [372, 455, 0.58, 1.57], [12, 585, 0.62, 1.57],
    [13, 225, 0.52, 1.57], [370, 570, 0.54, 1.57], [14, 680, 0.5, 1.57]
  ],
  rocks: [],
  buildings: [],
...
const GRAND_OVAL_DECOR: TrackDecor = {
  ...
  boats: [
    [52, 300, 0.78, 1.57], [338, 400, 0.78, 1.57], [52, 540, 0.72, 1.57],
    [340, 250, 0.62, 1.57], [50, 660, 0.6, 1.57]
  ],
  rocks: [],
  buildings: [],
...
const OPEN_WATER_DECOR: TrackDecor = {
  ...
  boats: [
    [12, 250, 0.6, 1.57], [376, 340, 0.6, 1.57], [12, 620, 0.58, 1.57],
    [378, 560, 0.54, 1.57], [14, 430, 0.56, 1.57]
  ],
  rocks: [],
  buildings: [],
